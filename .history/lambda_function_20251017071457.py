...
def lambda_handler(event, context):
    ...
    try:
        ...
        # New filename input property
        PDF_FILENAME = event['pdf_filename'] # <--- CHANGED FROM 'output_filename'
        ...
        # Format: eventName-user/
        OUTPUT_KEY_PREFIX = f"{EVENT_NAME}-{USER}/"
        FINAL_OUTPUT_KEY = f"{OUTPUT_KEY_PREFIX}{PDF_FILENAME}" # Uses new PDF_FILENAME
